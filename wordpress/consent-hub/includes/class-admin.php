...
class CH_Admin {
	...
	public static function action_links( $links ) {
		$url = admin_url( 'admin.php?page=consent-hub-dashboard' );
	...
	public static function sanitize( $input ) {
		...
		$clean['gcm_wait_update'] = isset( $input['gcm_wait_update'] )
			? absint( $input['gcm_wait_update'] ) : $defaults['gcm_wait_update'];

		$clean['logging_retention'] = isset( $input['logging_retention'] )
			? absint( $input['logging_retention'] ) : $defaults['logging_retention'];
	...
	/* ══════════════════════════════════════════════════════════
	   Section Renderers (called by CH_Dashboard::render_page)
	   ══════════════════════════════════════════════════════════ */

	public static function render_banner_section( $s ) {
		?>
		<div class="ch-card">
			<div class="ch-card-body">
				<div class="ch-form-section-title"><?php esc_html_e( 'Banner', 'consent-hub' ); ?></div>
				<div class="ch-field">
				...
				<div class="ch-form-section-title" style="margin-top:24px"><?php esc_html_e( 'Textos del banner', 'consent-hub' ); ?></div>
				<?php
				...
				<div class="ch-form-section-title" style="margin-top:24px"><?php esc_html_e( 'Textos de preferencias', 'consent-hub' ); ?></div>
				<?php
	...
	public static function render_categories_section( $s ) {
		$cats = array( 'analytics', 'marketing', 'preferences' );
		?>
		<div class="ch-card">
			<div class="ch-card-body">
				<?php foreach ( $cats as $cat ) : ?>
				<div class="ch-form-section-title"><?php echo esc_html( ucfirst( $cat ) ); ?></div>
				<?php
	...
	public static function render_appearance_section( $s ) {
		?>
		<div class="ch-card">
			<div class="ch-card-body">
				<div class="ch-form-section-title"><?php esc_html_e( 'Colores', 'consent-hub' ); ?></div>
				...
				<div class="ch-form-section-title" style="margin-top:24px"><?php esc_html_e( 'Forma', 'consent-hub' ); ?></div>
	...
	public static function render_gcm_section( $s ) {
		?>
		<div class="ch-card">
			<div class="ch-card-body">
				<div class="ch-field">
	...
	public static function render_blocker_section( $s ) {
		?>
		<div class="ch-card">
			<div class="ch-card-body">
				<div class="ch-field">
	...
	public static function render_logging_section( $s ) {
		?>
		<div class="ch-card">
			<div class="ch-card-body">
				<div class="ch-field">
	...
	public static function render_geo_section( $s ) {
		?>
		<div class="ch-card">
			<div class="ch-card-body">
				<div class="ch-field">
	...
	public static function text_field( $key, $label, $s ) {
		echo '<div class="ch-field">';
		echo '<label>' . esc_html( $label ) . '</label>';
		echo '<div class="ch-field-inner"><input type="text" name="ch_settings[' . esc_attr( $key ) . ']" value="' . esc_attr( $s[ $key ] ) . '"></div>';
		echo '</div>';
	}

	public static function textarea_field( $key, $label, $s ) {
		echo '<div class="ch-field">';
		echo '<label>' . esc_html( $label ) . '</label>';
		echo '<div class="ch-field-inner"><textarea name="ch_settings[' . esc_attr( $key ) . ']" rows="3">' . esc_textarea( $s[ $key ] ) . '</textarea></div>';
		echo '</div>';
	}

	public static function color_field( $key, $label, $s ) {
